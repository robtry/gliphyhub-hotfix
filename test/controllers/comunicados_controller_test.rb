...
class ComunicadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comunicado" do
    assert_difference('Comunicado.count') do
      post comunicados_url, params: { comunicado: { mensaje: @comunicado.mensaje, mensaje_markdown: @comunicado.mensaje_markdown, prioridad: @comunicado.prioridad, titulo: @comunicado.titulo, user_id: @comunicado.user_id, visitas: @comunicado.visitas } }
    end
  ...
  test "should update comunicado" do
    patch comunicado_url(@comunicado), params: { comunicado: { mensaje: @comunicado.mensaje, mensaje_markdown: @comunicado.mensaje_markdown, prioridad: @comunicado.prioridad, titulo: @comunicado.titulo, user_id: @comunicado.user_id, visitas: @comunicado.visitas } }
