...
class ComunicadosTest < ApplicationSystemTestCase
  ...
  test "creating a Comunicado" do
    ...
    fill_in "Mensaje", with: @comunicado.mensaje
    fill_in "Mensaje Markdown", with: @comunicado.mensaje_markdown
    fill_in "Prioridad", with: @comunicado.prioridad
    fill_in "Titulo", with: @comunicado.titulo
    fill_in "User", with: @comunicado.user_id
    fill_in "Visitas", with: @comunicado.visitas
